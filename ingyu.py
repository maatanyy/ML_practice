...
model.fit(xtrain,ytrain,validation_data=(xtrain,ytrain),
          verbose=2,epochs=1)
...
np.ravel(real_price, order='C')
predicted_value=np.reshape(predicted_value,(len(ytrain),1))
...
#
#         count = count + 1
#     # elif(16.37<=predicted_bmi[j]<17.84 and 16.37<=real_bmi[j]<17.84):
#     #     plt.scatter(j, real_bmi[j], c="g")
#     #
#     #     count = count + 1
#     # elif(17.84<=predicted_bmi[j]<19.3 and 17.84<=real_bmi[j]<19.3):
#     #     plt.scatter(j, real_bmi[j], c="c")
#     #
#     #     count = count + 1
...
#
#         count = count + 1
#     # elif(20.77<=predicted_bmi[i]<22.24 and 20.77<=real_bmi[j]<22.24):
#     #     plt.scatter(j, real_bmi[j], c="y")
#     #
#     #     count = count + 1
#     # elif(22.24<=predicted_bmi[j]<23.7 and 22.24<=real_bmi[j]<23.7):
#     #     plt.scatter(j, real_bmi[j], c="k")
#     #     count = count + 1
#     elif(23.7<=predicted_bmi[j]<28.1 and 23.7<=real_bmi[j]<28.1):
#         plt.scatter(j, real_bmi[j], c="violet")
#         count = count + 1

plt.scatter(1,1,c="r",label="A")
plt.scatter(1,1,c="b",label="B")
plt.scatter(1,1,c="m",label="C")
plt.scatter(1,1,c="violet",label="D")
